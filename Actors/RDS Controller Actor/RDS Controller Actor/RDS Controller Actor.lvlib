...
<Library LVVersion="15008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="Controller Send State Msg.lvclass" Type="LVClass" URL="../RDS Controller Actor Messages/Controller Send State Msg/Controller Send State Msg.lvclass"/>
	</Item>
	<Item Name="Controller.ctl" Type="VI" URL="../Controller.ctl"/>
	<Item Name="Pack Control Message.vi" Type="VI" URL="../RDS Controller Actor/Pack Control Message.vi"/>
	<Item Name="RDS Controller Actor.lvclass" Type="LVClass" URL="../RDS Controller Actor/RDS Controller Actor.lvclass"/>
</Library>
